...
def test_spidercloud_adobe_r161751_normalizes_fields_and_posted_date():
...
def test_spidercloud_adobe_r161751_location_components_and_salary_range():
    normalized = _normalize_adobe_job()
    ...
    assert comp_range.get("low") == 115500
    assert comp_range.get("high") == 167250


def test_spidercloud_adobe_r161751_description_strips_junk():
    normalized = _normalize_adobe_job()
