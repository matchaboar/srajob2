...
from job_scrape_application.workflows.scrapers.spidercloud_scraper import SpidercloudScraper  # noqa: E402
...
class TestGithubEmptyResponseHandling:
    ...
    def test_empty_list_response_not_invalid(self):
        ...
        """
        scraper = SpidercloudScraper(deps=None, provider="spidercloud")
        ...
        result = scraper._process_spidercloud_sync_response(
            raw_result,
            original_url,
            started_at,
            handler=handler,
...
class TestErrorClassificationAllSeen:
    ...
    def test_all_seen_not_zero_urls_error(self):
        ...
        """
        from job_scrape_application.workflows.activities import _enqueue_from_scrape_unit_testable
