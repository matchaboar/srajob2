...
def test_store_scrape_ingest_uses_trimmed_descriptions(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def fake_query(name: str, args: Dict[str, Any] | None = None):  # noqa: ARG001
        return []
