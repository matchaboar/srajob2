...
def test_store_scrape_enqueues_detail_urls_from_listing_payload(monkeypatch: pytest.MonkeyPatch):
    ...
    def fake_fetch_seen(source: str, pattern: str | None):
...
def test_listing_urls_scraped_by_job_details_worker_enqueue_jobs(monkeypatch: pytest.MonkeyPatch):
    """
