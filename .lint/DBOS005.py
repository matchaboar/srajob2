...
RULE_ID = "DBOS005"
SUMMARY = "Async workflows must use async workflow launch methods."
...
class Checker(ast.NodeVisitor):
    """Checks for sync workflow launch methods in async workflows."""
    ...
    def _has_noqa_comment(self, lineno: int) -> bool:
        ...
        return "noqa: DBOS005" in line or "noqa:DBOS005" in line
...
def check_file(file_path: Path, source: str | None = None) -> Sequence[Violation]:
    """Check a single file for DBOS005 violations."""
    if source is None:
