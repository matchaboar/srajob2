...
async def test_fetchfox_crawl_queues_urls_and_passes_skip_list(monkeypatch, datadog_crawl_payload):
    ...
    def fake_filter_new_job_urls(urls: List[str]):
...
def test_store_scrape_enqueues_urls_when_no_jobs(monkeypatch, datadog_crawl_payload):
    ...
    acts.store_scrape(crawl_payload)
