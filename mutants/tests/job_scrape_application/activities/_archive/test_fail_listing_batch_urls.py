...
def test_fail_listing_batch_urls_marks_failed(monkeypatch):
    """Test that fail_listing_batch_urls marks URLs as failed.
    ...
    res = acts.fail_listing_batch_urls(batch, "batch_failed")
...
def test_fail_listing_batch_urls_noop_when_empty(monkeypatch):
    """Test that fail_listing_batch_urls is a noop with empty URLs.
    ...
    res = acts.fail_listing_batch_urls({"urls": []})
