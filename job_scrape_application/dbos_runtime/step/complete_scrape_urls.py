...
def complete_scrape_urls_step(
    ...
    """Mark scrape URLs as completed, failed, or pending retry.

    This step updates the status of URLs in the SQLite queue after they
    have been processed or encountered an error.
