# Extraction Steps: coinbase

**Detail URL:** `https://boards-api.greenhouse.io/v1/boards/coinbase/jobs/7404504`
**Source URL:** `https://api.greenhouse.io/v1/boards/coinbase/jobs`
**Handler:** `greenhouse`
...
```json
{
  "url": "https://boards-api.greenhouse.io/v1/boards/coinbase/jobs/7404504",
  "handler": "greenhouse"
}
```
...
```json
{
  "urls": [
    {
      "url": "https://boards-api.greenhouse.io/v1/boards/coinbase/jobs/7404504",
      "sourceUrl": "https://api.greenhouse.io/v1/boards/coinbase/jobs",
...
```json
{
  "title": {
    ...
    "value": "Accounting Intern"
  },
  "company": {
    "winner": "raw_row_company",
    "value": "Coinbase Careers Page"
  },
  "location": {
    "winner": "raw_row_location",
    "value": "Hybrid - New York, NY"
  },
  "remote": {
...
**Title unchanged:** `Accounting Intern`

**Full patch applied:**
```json
{
  "heuristicAttempts": 1,
  "heuristicLastTried": 1768590832338,
  "heuristicVersion": 5,
  "location": "Hybrid - New York, NY",
  "locationSearch": "Hybrid - New York, NY",
  "remote": false
}
```
...
|-------|----------------|-------|
| title | `raw_row_title` | `Accounting Intern` |
| company | `raw_row_company` | `Coinbase Careers Page` |
| location | `raw_row_location` | `Hybrid - New York, NY` |
| remote | `default_remote` | `(none)` |
| level | `explicit_level_field` | `mid` |
| compensation | `unknown_compensation` | `(none)` |
| posted_at | `explicit_posted_at_field` | `2025-11-17 19:24:23` |
...
| **raw_row_title** 🏆 | EXPLICIT_FIELD | ✅ | `Accounting Intern` | Valid title |
...
**Final Value:** `Coinbase Careers Page`
...
| **raw_row_company** 🏆 | EXPLICIT_FIELD | ✅ | `Coinbase Careers Page` | Valid company name |
| url_company | URL_DERIVED | ✅ | `Coinbase` | Valid company name |
...
**Final Value:** `Hybrid - New York, NY`
...
| **raw_row_location** 🏆 | EXPLICIT_FIELD | ✅ | `Hybrid - New York, NY` | Valid location |
...
| country_only_fallback_location | CUSTOM_550 | ✅ | `Hybrid - New York, NY` | Country-only fallback: Valid location |
...
| location_remote | EXPLICIT_FIELD | ❌ | `` | Location 'Hybrid - New York, NY' present but not i |
...
| remote_company | CUSTOM_650 | ❌ | `` | Company 'Coinbase Careers Page' not in remote comp |
...
**Final Value:** `2025-11-17 19:24:23`
**Winning Strategy:** `explicit_posted_at_field`

| Strategy | Priority | Valid | Value | Reason |
|----------|----------|-------|-------|--------|
| **explicit_posted_at_field** 🏆 | STRUCTURED_DATA | ✅ | `2025-11-17 19:24:23` | Valid date: 2025-11-17T19:24:23 |
...
| now_fallback_posted_at | FALLBACK | ✅ | `2026-01-16 12:13:52.342637` | Using current time as fallback (date unknown) |

#### DESCRIPTION

**Final Value:** `&lt;div class=&quot;content-intro&quot;&gt;&lt;p&gt;Ready to be pushed beyond what you think you’re capable of?&lt;/p&gt; &lt;p&gt;At Coinbase, our mission is to increase economic freedom in the world. It’s a massive, ambitious opportunity that demands the best of us, every day, as we build the emerging onchain platform — and with it, the future global financial system.&lt;/p&gt; &lt;p&gt;To achieve our mission, we’re seeking a very specific candidate. We want someone who is passionate about our mission and who believes in the power of crypto and blockchain technology to update the financial system. We want someone who is eager to leave their mark on the...`
**Winning Strategy:** `normalized_markdown_description`

| Strategy | Priority | Valid | Value | Reason |
|----------|----------|-------|-------|--------|
| structured_data_description | STRUCTURED_DATA | ❌ | `` | No structured data available |
| **normalized_markdown_description** 🏆 | SITE_HANDLER | ✅ | `&lt;div class=&quot;content-in` | Valid description (665 chars, 100 words) |
| raw_row_description | EXPLICIT_FIELD | ✅ | `&lt;div class=&quot;content-in` | Valid description (665 chars, 100 words) |
| raw_markdown_description | CUSTOM_800 | ✅ | `&lt;div class=&quot;content-in` | Valid description (665 chars, 100 words) |
...
| Is Remote | `False` |
| Level | `mid` |
| Posted At | `1763432663000` |
| Description Words | `100` |
| Cost (milli-cents) | `3` |
| URL | `https://www.coinbase.com/careers/positions/7404504?gh_jid=7404504` |
...
```json
{
  ...
  "company": "Coinbase Careers Page",
  "location": "Hybrid - New York, NY",
  "description": "&lt;div class=&quot;content-intro&quot;&gt;&lt;p&gt;Ready to be pushed beyond what you think you’re capable of?&lt;/p&gt; &lt;p&gt;At Coinbase, our mission is to increase economic freedom in the world. It’s a massive, ambitious opportunity that demands the best of us, every day, as we build the emerging onchain platform — and with it, the future global financial system.&lt;/p&gt; &lt;p&gt;To achieve our mission, we’re seeking a very specific candidate. We want someone who is passionate about our...",
  "url": "https://www.coinbase.com/careers/positions/7404504?gh_jid=7404504",
  "apply_url": "https://www.coinbase.com/careers/positions/7404504?gh_jid=7404504",
  "posted_at": 1763432663000,
  "level": "mid",
  "cost_milli_cents": 3
}
```
