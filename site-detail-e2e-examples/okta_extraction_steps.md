# Extraction Steps: okta

**Detail URL:** `https://boards-api.greenhouse.io/v1/boards/okta/jobs/7378568`
**Source URL:** `https://api.greenhouse.io/v1/boards/okta/jobs`
**Handler:** `greenhouse`
...
```json
{
  "url": "https://boards-api.greenhouse.io/v1/boards/okta/jobs/7378568",
  "handler": "greenhouse"
}
```
...
```json
{
  "urls": [
    {
      "url": "https://boards-api.greenhouse.io/v1/boards/okta/jobs/7378568",
      "sourceUrl": "https://api.greenhouse.io/v1/boards/okta/jobs",
...
```json
{
  ...
  "location": {
    ...
    "value": "Bellevue, Washington; Chicago, Illinois; Toronto, Ontario, Canada"
  },
  "remote": {
  ...
  "posted_at": {
    ...
    "value": "2025-11-12T10:52:04"
  },
  "description": {
    "winner": "normalized_markdown_description",
    "value": "&lt;div class=&quot;content-intro&quot;&gt;&lt;p&gt;&lt;span style=&quot;color: #000000;&quot;&gt;&lt;strong&gt;Get to know Okta&lt;br&gt;&lt;br&gt;&lt;/strong&gt;&lt;/span&gt;Okta is The World’s Identity Company. We free everyone to safely use any technology, anywhere, on any device or app. Our flexible and neutral products, Okta Platform and Auth0 Platform, provide secure access, authentication, and automation, placing identity at the core of business security and growth.&lt;br&gt;&lt;br&gt;At Okta, we celebrate a variety of perspectives and experiences. We are not looking for someone who checks every single box - we’re looking for lifelong learners and people who can make us better with their unique experiences.&amp;nbsp;&lt;br&gt;&lt;br&gt;Join our team! We’re building a world wher
```
...
**Title unchanged:** `ABX Marketing Manager`

**Full patch applied:**
```json
{
  "heuristicAttempts": 1,
  "heuristicLastTried": 1768591608087,
  "heuristicVersion": 5,
  "locations": [
    "Bellevue, WA",
    "Chicago, IL",
  ...
  "locationSearch": "IL Canada Toronto Bellevue Chicago WA",
  "countries": [
    "United States",
    "Canada"
  ],
...
|-------|----------------|-------|
| title | `raw_row_title` | `ABX Marketing Manager` |
| company | `raw_row_company` | `Okta` |
| location | `raw_row_location` | `Bellevue, Washington; Chicago, Illinois; Toronto, ` |
| remote | `default_remote` | `(none)` |
| level | `explicit_level_field` | `senior` |
| compensation | `unknown_compensation` | `(none)` |
| posted_at | `explicit_posted_at_field` | `2025-11-12 10:52:04` |
...
**Final Value:** `ABX Marketing Manager`
...
| **raw_row_title** 🏆 | EXPLICIT_FIELD | ✅ | `ABX Marketing Manager` | Valid title |
...
| **raw_row_company** 🏆 | EXPLICIT_FIELD | ✅ | `Okta` | Valid company name |
| url_company | URL_DERIVED | ✅ | `Okta` | Valid company name |
| content_pattern_company | CONTENT_PATTERN | ✅ | `our team` | Found 'Join Company' pattern |
| hinted_company | HEURISTIC | ❌ | `` | No company in hints |
| fallback_company | FALLBACK | ✅ | `Unknown` | Fallback to 'Unknown' company name |

#### LOCATION

**Final Value:** `Bellevue, Washington; Chicago, Illinois; Toronto, Ontario, Canada`
...
| **raw_row_location** 🏆 | EXPLICIT_FIELD | ✅ | `Bellevue, Washington; Chicago,` | Valid location |
...
| country_only_fallback_location | CUSTOM_550 | ✅ | `Bellevue, Washington; Chicago,` | Country-only fallback: Valid location |
...
| location_remote | EXPLICIT_FIELD | ❌ | `` | Location 'Bellevue, Washington; Chicago, Illinois; |
...
| remote_company | CUSTOM_650 | ❌ | `` | Company 'Okta' not in remote company list |
...
**Final Value:** `2025-11-12 10:52:04`
**Winning Strategy:** `explicit_posted_at_field`

| Strategy | Priority | Valid | Value | Reason |
|----------|----------|-------|-------|--------|
| **explicit_posted_at_field** 🏆 | STRUCTURED_DATA | ✅ | `2025-11-12 10:52:04` | Valid date: 2025-11-12T10:52:04 |
...
| now_fallback_posted_at | FALLBACK | ✅ | `2026-01-16 12:26:48.092917` | Using current time as fallback (date unknown) |

#### DESCRIPTION

**Final Value:** `&lt;div class=&quot;content-intro&quot;&gt;&lt;p&gt;&lt;span style=&quot;color: #000000;&quot;&gt;&lt;strong&gt;Get to know Okta&lt;br&gt;&lt;br&gt;&lt;/strong&gt;&lt;/span&gt;Okta is The World’s Identity Company. We free everyone to safely use any technology, anywhere, on any device or app. Our flexible and neutral products, Okta Platform and Auth0 Platform, provide secure access, authentication, and automation, placing identity at the core of business security and growth.&lt;br&gt;&lt;br&gt;At Okta, we celebrate a variety of perspectives and experiences. We are not looking for someone who checks every single box - we’re looking for lifelong learners and people who can make us better with their unique experiences.&amp;nbsp;&lt;br&gt;&lt;br&gt;Join our team! We’re building a world where Identity belongs to you.&lt;/p&gt;&lt;/div&gt;&lt;h1&gt;&lt;strong&gt;ABX...`
**Winning Strategy:** `normalized_markdown_description`

| Strategy | Priority | Valid | Value | Reason |
|----------|----------|-------|-------|--------|
| structured_data_description | STRUCTURED_DATA | ❌ | `` | No structured data available |
| **normalized_markdown_description** 🏆 | SITE_HANDLER | ✅ | `&lt;div class=&quot;content-in` | Valid description (874 chars, 100 words) |
| raw_row_description | EXPLICIT_FIELD | ✅ | `&lt;div class=&quot;content-in` | Valid description (874 chars, 100 words) |
| raw_markdown_description | CUSTOM_800 | ✅ | `&lt;div class=&quot;content-in` | Valid description (874 chars, 100 words) |
...
| Field | Value |
|-------|-------|
| Title | `ABX Marketing Manager` |
| Company | `Okta` |
| Location | `Bellevue, WA` |
| Is Remote | `False` |
| Level | `senior` |
| Posted At | `1762969924000` |
| Description Words | `100` |
| Cost (milli-cents) | `3` |
| URL | `https://www.okta.com/company/careers/opportunity/7378568?gh_jid=7378568` |
...
```json
{
  ...
  "description": "&lt;div class=&quot;content-intro&quot;&gt;&lt;p&gt;&lt;span style=&quot;color: #000000;&quot;&gt;&lt;strong&gt;Get to know Okta&lt;br&gt;&lt;br&gt;&lt;/strong&gt;&lt;/span&gt;Okta is The World’s Identity Company. We free everyone to safely use any technology, anywhere, on any device or app. Our flexible and neutral products, Okta Platform and Auth0 Platform, provide secure access, authentication, and automation, placing identity at the core of business security and growth.&lt;br&gt;&lt;br&gt;At...",
  "url": "https://www.okta.com/company/careers/opportunity/7378568?gh_jid=7378568",
  "apply_url": "https://www.okta.com/company/careers/opportunity/7378568?gh_jid=7378568",
  "posted_at": 1762969924000,
  "level": "senior",
  "cost_milli_cents": 3
}
```
